...
<div class="container mt-4">
  ...
  if ($result_kat->num_rows > 0) {
    ...
    echo "<h2 class='pb-2 mb-4 border-bottom'>Berita Kategori: <span class='text-pink-theme'>" . htmlspecialchars($kategori['nama_kategori']) . "</span></h2>";
          ...
          <div class="row g-0">
            ...
            <div class="col-md-8">
              <div class="card-body d-flex flex-column h-100">
                <h5 class="card-title">
                  <a href="detail.php?slug=<?php echo htmlspecialchars($b['slug']); ?>"><?php echo htmlspecialchars($b['judul']); ?></a>
                </h5>
                ...
                <div class="mt-auto pt-2">
                   <a href="detail.php?slug=<?php echo htmlspecialchars($b['slug']); ?>" class="btn btn-pink btn-sm">Baca Selengkapnya</a>
                </div>
              </div>
            </div>
          </div>
